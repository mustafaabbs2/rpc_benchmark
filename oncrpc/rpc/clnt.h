...
extern CLIENT * clnt_create( char *host, u_long prog, u_long vers, char *prot);
...
/* extern CLIENT *clnttcp_create(DOTS); */
 extern CLIENT *clnttcp_create(struct sockaddr_in *raddr,u_long prog,u_long version,register int *sockp,u_int sendsz,u_int recvsz);
